...
%requires: lualatex, gnuplot, pretty much all of texlive
%can be run with ../WDS-General/util/llatex WDSModelSpec.tex --doublerun --clean
...
\def\thisfirm{WDataSci / Wypasek Data Science}
\def\thisdate{2022-03}
...
\DocumentTitlePageWithCR{\thistitle}{\thissubtitle}{Version \thisversion }{}{\thisdate }{\thiscopyright }{\thisauthor}{\thisabstract }
...
\subsection{Dictionary\label{dictionary}}
            ...
            A \highlight{Dictionary} (Synonyms: Namespace, DB Field Metadata) (Abbreviations: Dict)
