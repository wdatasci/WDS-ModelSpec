...
AddIn XLLAddIn_WDS_XLM_GET_WORKSPACE(
	Function(XLL_LPXLOPER, "WDS_XLM_GET_WORKSPACE", "WDS.XLM.GET.WORKSPACE")
	.Arguments({
		Arg(XLL_WORD, "type_num", "is a number specifying the type of workspace information you want.")
		})
	.Uncalced()
	.Category("WDS.XLM")
	.FunctionHelp("A wrapper for the XLM Get.Workspace function (Use.")
);
LPXLOPER12 WINAPI
...
AddIn XLLAddIn_WDS_XLM_GET_XLL_NAME(
	Function(XLL_LPXLOPER, "WDS_XLM_GET_XLL_NAME", "WDS.XLM.GET.XLL_Name")
	.Uncalced()
	.Category("WDS.XLM")
...
AddIn XLLAddIn_WDS_XLM_GET_WORKBOOK(
	Function(XLL_LPXLOPER, "WDS_XLM_GET_WORKBOOK", "WDS.XLM.GET.WORKBOOK")
	.Arguments({
		Arg(XLL_WORD, "type_num", "is a number that specifies what type of workbook information you want.")
...
LPXLOPER12 WINAPI
WDS_XLM_GET_WORKBOOK(WORD type_num, LPOPER name_text)
{
	LPOPER result = nullptr;
	wstring tmpstring;
	try {
...
AddIn XLLAddIn_WDS_XLM_GET_DOCUMENT(
	Function(XLL_LPXLOPER, "WDS_XLM_GET_DOCUMENT", "WDS.XLM.GET.DOCUMENT")
	.Arguments({
		Arg(XLL_WORD, "type_num", "is a number that specifies what type of information you want.")
		,Arg(XLL_LPXLOPER, "name_text", "is the name of an open workbook. If name_text is omitted, it is assumed to be the active workbook.")
		})
	.Uncalced()
	.Category(L"WDS.XLM")
