    ...
    public class DBB
    {
        ...
        //throws WDSException, Exception
        {
            ...
            if ( this.bUsingByteBufferOnly && this.data == null && !this.datawrap.isDirect() )
                throw new WDSException("Error, the wrapped ByteBuffer inside DBB must be direct");
            /* <<< Java */
            if ( this.bHasFLenVLenSplit && (this.Length < this.nDBBRequiredBytes) )
                throw new WDSException("Error, the wrapped Length inside DBB must be greater than nDDBRequiredBytes");
        ...
        //throws WDSException
        {
            if ( arg.isDirect() && !arg.hasArray() ) {
                ...
                throw new WDSException("Error DBB requires a Direct ByteBuffer with backing array");
        }
        /* <<< Java */
        ...
        //throws WDSException, Exception
        {
            ...
            if ( !WDS.Util.bIn(LayoutStyle, "WDSC", "WDSH", "WDSD") )
                throw new WDSException("Error XDataBuffer LayoutStyle is not WDSH, WDSD, or WDSC");
        ...
        //throws WDSException
        {
            ...
            if ( this.nDBBRequiredBytes > this.Length )
                throw new WDSException("Error, not enough allocated space in internal byte[] for DBB");
            this.flenoffset = this.offset + this.nDBBLeadingBytes;
            this.flenlength = this.nDBBFLenBytes;
        ...
        {
            if ( nLeadingBytes < 64 )
                throw new WDSException("Error, AsUsualLayout requires at least 8*8 bytes for leading data");
            ...
            this.nDBBRequiredBytes = this.nDBBLeadingBytes + this.nDBBFLenBytes + this.nDBBVLenBytes;
            if ( this.nDBBRequiredBytes > this.Length )
                throw new WDSException("Error, not enough allocated space in internal byte[] for DBB," + this.nDBBRequiredBytes + ", " + this.Length);
        ...
        //throws WDSException
        {
            ...
            try {
                ...
                throw new WDSException("Error in extracting VLen String from ByteBuffer:", e);
            }
            /* <<< Java */
            return rv;
        }
        ...
        {
            if ( layer != 1 )
                throw new WDSException("Error, GetLayerVLenString can only be called from layer 1 (which points to space in layer 2)");
        ...
        {
            if ( layer != 1 )
                throw new WDSException("Error, PutLayerVLenString can only be called from layer 1 (which points to space in layer 2)");
            ...
            try {
                ...
                throw new WDSException("Error in putVLenString ", e);
            }
        }
