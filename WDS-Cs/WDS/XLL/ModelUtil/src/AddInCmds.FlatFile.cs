        ...
        public static void ExportXmlMappedListToCSV()
        {
            ...
            try {
                ...
                try {
                    ...
                    throw new WDSException("Error: could not pull XmlMap from selection");
                }
                ...
                if ( aListObject.ListColumns.Count != nColumns ) {
                    throw new WDSException("ListObject Column Count Does Not Match Schema Node List Count!");
                }
                ...
                WDSException we=new WDSException("Error in ExportXMLMappedListToCSV to "+sFileName,e);
