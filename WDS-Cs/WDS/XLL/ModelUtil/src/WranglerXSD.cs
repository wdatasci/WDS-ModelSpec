    ...
    public class WranglerXSD
    {
        ...
        //throws WDSException
        {
            ...
            try {
                ...
                if ( aRecordSetMD.SchemaMatter == null )
                    throw new WDSException("Error, aRecordSetMD.SchemaMatter not populated");
                ...
                if ( aRecordSetMD.SchemaMatter.InputSchema == null ) {
                    if ( aRecordSetMD.SchemaMatter.InputSchemaString == null ) {
                        if ( aRecordSetMD.SchemaMatter.InputSchemaFileName == null )
                            throw new WDSException("Error, InputMap XSD not provided or valid!");
                        aRecordSetMD.SchemaMatter.InputSchemaString = WDS.Util.FetchFileAsString(aRecordSetMD.SchemaMatter.InputSchemaFileName);
                    }
                    /* Java >>> *
                    if ( bUsingJniPMML )
        ...
        //throws WDSException
        {
            ...
            try {
                ...
                if ( rns.equals(rn) )
                    throw new WDSException("Error, RecordSetMD needs a valid RecordSetElementName, it's singular version, and they cannot be equal");
