    ...
    public class WranglerDBB
    {
        ...
        //throws WDSException, Exception
        {
            ...
            if ( !this.Header.Buffer.LayoutStyle.equals("WDSH") )
                throw new WDSException("Error, layout for Header must be WDSH");
        ...
        {
            if ( this.Header == null )
                throw new WDSException("Error, DBB Wrangler Header must be provided before RecordSetBuffer can be set");
            this.RecordSet.Buffer = null;
            this.RecordSet.Buffer = arg;
            this.RecordSet.Buffer.cReadExistingLayout();
            if ( !this.RecordSet.Buffer.LayoutStyle.equals("WDSD") )
                throw new WDSException("Error, layout for RecordSet must be WDSD");
            this.RecordSet.Buffer.isValid();
            return this;
        }
            ...
            try {
                ...
                try {
                    ...
                    if ( nBlockAllocatedSize > this.Header.Buffer.Length )
                        throw new WDSException("Error, HeaderBuffer capacity, " + this.Header.Buffer.Length
                    ...
                    throw new WDSException("Error in RecordSetMD processing of Header DBB:", e);
                }
                ...
                throw new WDSException("Error in ProcessInputMapFor", e);
            }
        }
        ...
        //throws WDSException
        {
            ...
            try {
                ...
                for ( i = 0 ; i < nRows ; i++, bptr += (int) aInputRecordSetMD.DBBMatter.RecordSet.Buffer.nRecordFLenBytes ) {
                    ...
                    for ( jj = 0 ; jj < nColumns ; jj++ ) {
                        switch ( aInputRecordSetMD.Column[jj].DTyp ) {
                            ...
                            default:
                                throw new WDSException("Error, column type not implemented");
                        }
                    }
                ...
                throw new WDSException("Error reading from DBB, row " + ri + ":", e);
            }
        }
        ...
        //throws WDSException
        {
            try {
                ...
                if ( this.Header.Buffer == null )
                    throw new WDSException("Error, Header buffer not set before WriteMap!");
        ...
        //throws WDSException
        {
            ...
            if ( this.RecordSet.Buffer.nDBBRequiredBytes > this.RecordSet.Buffer.Length
                ...
                throw new WDSException("Error, capacity of underlying byte[] is insufficient in DBB.ProcessRecordSetParameters");
        ...
        //throws WDSException
        {
            try {
                ...
                if ( this.RecordSet.Buffer == null )
                    throw new WDSException("Error, RecordSet buffer not set before WriteSet!");
                    ...
                    for ( jj = 0, j = 0 ; jj < nColumns ; jj++, j++ ) {
                        ...
                        switch ( outRecordSetMD.Column[jj].DTyp ) {
                            ...
                            case FieldMDEnums.eDTyp.VLS:
                                ...
                                break;
                            default:
                                throw new WDSException("Error, unImplemented column type" + outRecordSetMD.Column[jj].DTyp.ToString());
                        }
                    }
                }
