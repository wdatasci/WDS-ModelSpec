...
namespace WDS.ModelSpec
{
    ...
    public class RecordSetMD
    {
        ...
        //Java public class __SchemaMatter
        //C#
        public class __SchemaMatter : WranglerXSD
        {
            public String InputSchemaFileName = null;
            public String InputSchemaString = null;
            //Java public Document InputSchema = null;
            //C#
            public XmlDocument InputSchema = null;
            ...
            public Boolean Equals(__SchemaMatter arg)
            {
                ...
                //Java if ( !this.InputSchema.equals(arg.InputSchema) ) return false;
                return true;
            }
            public void Dispose()
            {
            ...
            if ( isFileName || (schemadetails != null && schemadetails.Length > 0) ) {
                switch ( this.SchemaType ) {
                    ...
                    case RecordSetMDEnums.eSchemaType.XSD:
                        if ( isFileName ) {
                            String s = WDS.Util.FetchFileAsString(schemadetails);
        ...
        public RecordSetMD cWithRecordSetElementName(String arg)
        {
            if ( this.SchemaType.equals(RecordSetMDEnums.eSchemaType.XSD) ) {
                if ( this.SchemaMatter == null )
                    this.SchemaMatter = new __SchemaMatter();
                this.SchemaMatter.RecordSetElementName = new_String(arg);
            }
            return this;
        }
        ...
        public RecordSetMD cWithRecordSetAndRecordElementNames(String arg, String arg1)
        {
            if ( this.SchemaType.equals(RecordSetMDEnums.eSchemaType.XSD) ) {
                if ( this.SchemaMatter == null )
                    this.SchemaMatter = new __SchemaMatter();
                this.SchemaMatter.RecordSetElementName = new_String(arg);
                this.SchemaMatter.RecordElementName = new_String(arg1);
            }
            return this;
        }
        ...
        public RecordSetMD cWithRecordElementName(String arg)
        {
            if ( this.SchemaType.equals(RecordSetMDEnums.eSchemaType.XSD) ) {
                if ( this.SchemaMatter == null )
                    this.SchemaMatter = new __SchemaMatter();
                this.SchemaMatter.RecordElementName = new_String(arg);
            }
            return this;
        }
        ...
        //throws Exception
        {
            ...
            //C#
            throw new WDSException("Error, not implemented on the C# side");
