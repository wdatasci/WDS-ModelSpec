...
namespace WDS.ModelSpec
{
    ...
    public class RecordSet
    {
        ...
        public void Dispose()
        {
            //Java if ( this.Records != null ) this.Records.clear();
            //C#
            if ( this.Records != null ) this.Records.Clear();
            this.Records = null;
            //Java if ( this.Records_Orig != null ) this.Records_Orig.clear();
            //C#
        ...
        public RecordSet cAsInput()
        {
            ...
            if ( this.Records == null )
                //Java this.Records = new ArrayList<>(0);
                //C#
                this.Records = new List<Map<FieldName, Object>>(0);
            if ( this.Records_Orig == null )
                //Java this.Records_Orig = new ArrayList<>(0);
                //C#
                this.Records_Orig = new List<Object []>(0);
            return this;
        }
        ...
        //throws WDS.WDSException, Exception
        {
            ...
            if ( aRecordSetMD.Mode.equals(RecordSetMDEnums.eMode.Output) )
                throw new WDS.WDSException("Error, cannot Load an RecordSet from an RecordSetMD with Output Mode");
