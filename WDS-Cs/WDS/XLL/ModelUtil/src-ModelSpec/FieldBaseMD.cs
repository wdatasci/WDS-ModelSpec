...
namespace WDS.ModelSpec
{
    ...
    class FieldBaseMD
    {
        ...
        public FieldMDEnums.eDTyp DTyp = FieldMDEnums.eDTyp.Unk;
        public FieldMDEnums.eRTyp RTyp = FieldMDEnums.eRTyp.Unknown;
        ...
        //Java public WranglerHDF5.HDF5DataType HDF5DataType = null;
        //C#
        ...
        {
            if ( !WDS.Util.MatchingNullityAndValueEquals(this.Name, arg.Name) ) return false;
            ...
            if ( !WDS.Util.MatchingNullityAndValueEquals(this.Format, arg.Format) ) return false;
            ...
            if ( !WDS.Util.MatchingNullity(this.HDF5DataType, arg.HDF5DataType) ) return false;
        ...
        //throws WDS.WDSException
        {
            ...
            switch ( this.DTyp ) {
                ...
                case FieldMDEnums.eDTyp.Bln:
                    return 1;
                default:
                    throw new WDS.WDSException("Error, un-implemented OutputColumn DataType !");
            }
        }
        ...
        //Java @SuppressWarnings( "DuplicateBranchesInSwitch" )
