...
namespace com.WDataSci.JniPMML
{
    public class JniPMML
    {
        ...
        public JniPMMLItem CreateHandle(String aEvaluatorType, String aTag, object bFileOrString, String src, JniPMML objecthandler)
        {
            ...
            lock (this)
            {
                ...
                aJniPMMLItem.HandleMajorMinor = objecthandler.__Java.CallMethod<string>(method
        ...
        public object CreateHandle(String aEvaluatorType, object[] args, Func<String, object[], JniPMMLItem> lFunc, JniPMML objecthandler)
        {
            ...
            return ExcelAsyncUtil.Observe(aEvaluatorType
                , args
                , () => {
                   JniPMMLItem aJniPMMLItem = this.CreateHandle(aEvaluatorType, args[0].ToString(), args[1], args[2].ToString(),objecthandler);
                   return aJniPMMLItem;
                }
                );
        }
