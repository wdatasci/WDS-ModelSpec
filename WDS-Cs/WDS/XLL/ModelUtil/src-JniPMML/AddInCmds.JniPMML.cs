    ...
    public partial class AddIn : IExcelAddIn
    {
            ...
            )
        {
            ...
            else
            {
                ...
                {
                    if (__JniPMML.isTag(s))
                        h = __JniPMML.Handle(s);
            ...
            if (h < 0 || !__JniPMML.isHandle(h))
            {
                if (__JniPMML.isTag(arg0.ToString()))
                    h = __JniPMML.Handle(arg0.ToString());
                else
                    h = -2;
            }
            return h;
        ...
        {
            JniPMMLItem rv = null;
            if (!__JniPMML.TryGetObject(args[0].ToString(), out rv)) return rv;
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    throw new WDS.WDSException("Error, could not pull XMLMap from argument");
                }
                int nOutputStringMaxLength = WDS.Util.__OptionalIntValue(_nOutputStringMaxLength, 64);
            ...
            )
        {
            ...
            try
            {
                ...
                if (!xm.IsExportable)
                    throw new WDS.WDSException("Error in JniPMMLEval_CacheHeaders_guts, XMLMap is not exportable");
            ...
            )
        {
                ...
                unsafe
                {
                    ...
                    fixed (byte* bHeaderBlockSpanBytePtr = bHeaderBlockSpanByte)
                    {
                        ...
                        fixed (byte* bRecordSetBlockSpanBytePtr = bRecordSetBlockSpanByte)
                        {
                            ...
                            {
                                throw new WDS.WDSException("Error in JniPMML_Eval_guts", e);
                            }
            ...
            if (rv != null && rv.Length == 1 && rv[0, 0].toString().startsWith("Error"))
                throw new WDS.WDSException(rv[0, 0].toString());
            return rc;
        }
        ...
        public static void JniPMML_Eval_XmlMappedList()
        {
            ...
            try
            {
                ...
                {
                    throw new WDS.WDSException("Error, could  not pull XmlMap from selection", e);
                }
                ...
                if (msgboxresponse == System.Windows.Forms.DialogResult.Cancel)
                    throw new WDS.WDSException("Cancel");
                ...
                if (msgboxresponse == System.Windows.Forms.DialogResult.Yes)
                {
                    ...
                    try
                    {
                        if (HandleString.StartsWith("-1"))
                            throw new WDS.WDSException("ERROR, no model cached yet!  If workbook was just opened, possibly just recalc first and try again.");
                ...
                if (msgboxresponse == System.Windows.Forms.DialogResult.No || h < 0)
                {
                    ...
                    aJniPMMLItem = __JniPMML.CreateHandle("JniPMML", "Internal" + rndm.Next(0, 100000).ToString(), bIsPMMLInputFileOrString, sFileName,__JniPMML);
                    h = aJniPMMLItem.Handle();
                    bIsModelCached = false;
                }
                if (aJniPMMLItem == null)
                    throw new WDS.WDSException("Error, unable to use pre-cached or new JniPMML");
                            ...
                            catch
                            {
                                ...
                                while (!found)
                                {
                                    ...
                                    catch
                                    {
                                        i++;
                                        if (i > 5)
                                            throw new WDS.WDSException("Error, limit on number of name options");
                                    }
                                }
                            }
                            break;
        ...
        public static void JniPMML_XmlMap_Helper()
        {
            ...
            try
            {
                ...
                {
                    throw new WDS.WDSException("Error, could not get range of selection", e);
                }
                ...
                {
                    throw new WDS.WDSException("Error, could not get ListObject of selection", e);
                }
        ...
        public static void XmlMap_Helper()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            throw new WDS.WDSException("cached dictionary not carred over yet");
                            //String HandleString=JniPMML_Handle_LastUsed(null);
                            //String aTag;
                            //try {
                            //    if ( HandleString.StartsWith("-1") )
